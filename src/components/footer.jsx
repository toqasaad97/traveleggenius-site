      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            <a href="https://www.google.com/maps/place/6+Palestine+St,+Maadi,+Cairo+Governorate" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 hover:text-[#1A84C4] transition-colors">
              <span className="text-[#1A84C4]">📍</span>
              <span className="text-lg">معادي، شارع فلسطين 6، القاهرة - مصر</span>
            </a>
